...
THIS_VERSION :=1.0.0# library version
THIS_INTERFACE_VERSION :=1# library interface version
...
$(PATH_STAGE1)/$(THIS_NAME)$(EXT_EXEC): $(MAIN_OBJECTS) $(PATH_STAGE1)/lib$(THIS_LIBNAME)$(EXT_ARCHIVE)
